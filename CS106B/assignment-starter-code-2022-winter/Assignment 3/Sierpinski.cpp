                            ...
                            int order)
{
    ...
    if (order < 0)
    {
        error("order cannot smaller than 0");
    }
    // base case
    if (order == 0)
    {
    ...
    else
    {
        ...
        double x_mid3 = (x0 + x2) / 2;
        double y_mid3 = (y0 + y2) / 2;

        drawSierpinskiTriangle(window, x0, y0, x_mid1, y_mid1, x_mid3, y_mid3, order - 1);
        drawSierpinskiTriangle(window, x1, y1, x_mid1, y_mid1, x_mid2, y_mid2, order - 1);
        drawSierpinskiTriangle(window, x2, y2, x_mid2, y_mid2, x_mid3, y_mid3, order - 1);
    }
}
